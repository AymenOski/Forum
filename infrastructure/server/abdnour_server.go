...
func MyServer(db *sql.DB) *http.Server {
	...
	post_category_infra_repo := infra_repository.NewSQLitePostAggregateRepository(db, &post_infra_repo, &postCategory_infra_repo,&user_infra_repo, &post_reaction_infra_repo,&comment_infra_repo)
	// Middleware
	...
	comment_usecase := usecase.NewCommentService(&user_infra_repo, &comment_infra_repo, &post_infra_repo, &comment_reaction_infra_repo, &session_infra_repo)
